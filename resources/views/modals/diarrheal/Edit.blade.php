...
<div class="consul-show modal fade" id="editdiarrhealconsul" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <form class="edit-consult" action="{{route('diarrheal.update', 'id')}}" method="POST">
                ...
                <div class="modal-body">
                    <div class="res_prof row justify-content-center" id="details">
                        <div class="input-box">
                            <input name="Ediarrheal_id" id="Ediarrheal_id" type="block" placeholder="" hidden>
                        </div>
