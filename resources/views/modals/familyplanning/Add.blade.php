...
<div class="consul-add res-add modal fade" id="addfpconsul" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="searchResident" class="add-consult" action="{{route('familyplanning.store')}}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="input-box col-md-6 pb-3">
                            ...
                            <input type="text" name="method_used" id="method_used" placeholder="">
                        </div>
                    </div>
...
<script>
    $('#addfpconsul').on('hidden.bs.modal', function () {
        $('#addfpconsul form')[0].reset();
        });
</script>
