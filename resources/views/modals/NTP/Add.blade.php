...
<div class="consul-add res-add modal fade" id="addntpconsul" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="searchResident" class="add-consult" action="{{route('ntp.store')}}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="res_prof row justify-content-center" id="details">
                            ...
                            <div class="input-box d-flex justify-content-center col-md-12 pb-3 align-self-center">
                    ...
                    <div class="row">
                        <div class="input-box col-md-12 pb-3">
                            <div class="details tex-center">Age:</div>
...
<script>
    $('#addntpconsul').on('hidden.bs.modal', function () {
        $('#addntpconsul form')[0].reset();
        });
</script>
