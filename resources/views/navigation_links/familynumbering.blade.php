                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="white-space:nowrap; text-align:center; border-bottom: 1px solid black; border-top: 1px solid black;">
                                        ...
                                        <a type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" data-familynumber_id="{{$familynumberRec->id}}">Delete
                                        </a>
                                        @include('modals.family_numbering.PermanentDelete')
                                        @else
                                        {{-----***************************** SHOW BUTTON *******************************------}}
                                        <a data-bs-toggle="modal" type="button" class="btn btn-primary" data-bs-target="#viewfamilynumber" data-familynumber_id="{{ $familynumberRec->id }}" data-f_name="{{ $familynumberRec->f_name }}" data-m_name="{{ $familynumberRec->m_name }}" data-l_name="{{ $familynumberRec->l_name }}" data-purok="{{ $familynumberRec->purok }}">
                                            <i class="manage fas fa-eye"></i></a>
                                        @include('modals.family_numbering.Show')

                                        {{-----***************************** EDIT BUTTON *******************************------}}
                                        <a data-bs-toggle="modal" type="button" class="btn btn-warning" data-bs-target="#editfamilynumber" data-familynumber_id="{{ $familynumberRec->id }}" data-f_name="{{ $familynumberRec->f_name }}" data-m_name="{{ $familynumberRec->m_name }}" data-l_name="{{ $familynumberRec->l_name }}" data-purok="{{ $familynumberRec->purok }}">
                                            <i class="manage fas fa-edit"></i>
                                        </a>
                                        @include('modals.family_numbering.Edit')

                                        {{-----***************************** DELETE BUTTON *******************************------}}
                                        <a data-bs-toggle="modal" type="button" class="btn btn-danger" data-bs-target="#deletefamilynumber" data-familynumber_id="{{ $familynumberRec->id }}">
